            ...
            <table id="voituresTable" class="w3-table-all">
              ...
              ?>
                <tr class="item">
                  ...
                  <td class="action"> 
                    <i class="fad fa-pen" title="Modifier" id="btn" onclick="getModificationForm(<?php echo $row['vehicule_id']; ?>)"></i>
                    <i class="fad fa-trash" title="Supprimer" onclick="getSuppressionForm(<?php echo $row['vehicule_id']; ?>)"></i> 
                  </td>
                </tr> 
              <?php
                  }
