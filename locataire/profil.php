              ...
              <form action="./scripts/profilmodif.php" method="POST" class="signUpForm profileForm "   enctype="multipart/form-data">
                ...
                <div class="mb-3 input-group ProfilImageCont">
                  <label title="C'est Mieux d'utiliser une image avec un resolution 1x1">
                    <input type="file" name="locataire_image" class="ProfilImageSrc" class="form-control TableFormInput"  accept="image/png, image/jpeg, image/jpg, image/gif" onchange="showProfilImgModif()"  >
                    <img id="ProfilImageModif" src="../<?php if (file_exists('../'.$locataire['locataire_image'])) 
                                                                echo $locataire['locataire_image'] ; 
                                                              else
                                                                echo 'assets/Img/ProfileImg/default.jpg' ; 
                                                              ?>" alt="profileImage">
                    <div class="overlay">
                ...
                <div class="row form-group mb-3">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" name="nom" class="form-control signUpInput" id="FirstName" placeholder="Nom" maxlength="20" value="<?php echo $locataire['nom']   ?>" required>
                  </div>
                  <div class="col-sm-6">
                    <label for="LastName" class="ProfileLabel"> Prenom </label>
                    <input type="text"  name="prenom" class="form-control signUpInput" id="LastName" placeholder="Prenom" maxlength="20" value="<?php echo $locataire['prenom']   ?>"  required>
                  </div>
                </div>
                ...
                <div class="row form-group mb-3">
                  ...
                  <div class=" col-sm-6" >
                    ...
                    <input type="number" name="age"  class="form-control signUpInput" id="inputAge" placeholder="Age" min="18" max="100" value="<?php echo $locataire['age']   ?>"  required>
                  </div>
                  <div class=" col-sm-6 " >
                ...
                <div class="row form-group mb-3">
                  <div class=" col-sm-6 " >
                    ...
                    <div class=" input-group">
                      ...
                      <input type="tel" name="tel" class="form-control signUpInput" id="inputTel" pattern="[6-7][0-9]{8}" placeholder="Num De Tel: 666-666666" value="<?php echo $locataire['tel']   ?>"   required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <label for="Cin" class="ProfileLabel"> Cin </label>
                    <input type="text" name="cin" class="form-control signUpInput" id="Cin" maxlength="20" placeholder="Cin" value="<?php echo $locataire['cin']  ?>"  >
                  </div>
                </div>
                ...
                <div class="row form-group mb-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="number" name="code_postal" class="form-control signUpInput" id="inputZip" maxlength="5" min="10000" placeholder="Code Postal" value="<?php echo $locataire['code_postal']   ?>"  required>
                  </div>
                </div>

                <div class="mb-3">
                  <label for="inputAdresse" class="ProfileLabel"> Adresse </label>
                  <input type="text" name="adresse" class="form-control signUpInput" id="inputAdresse" maxlength="100" placeholder="Adresse" value="<?php echo $locataire['adresse']   ?>"  >
                </div>
                <div class="mb-4">
                  <label for="inputEmail" class="ProfileLabel"> Adresse Mail </label>
                  <input type="email" name="email" class="form-control signUpInput" id="inputEmail" pattern="^[a-zA-Z0-9]{2,10}[-|_]?[a-zA-Z0-9]{2,10}@[a-z]+\.[a-z]{2,5}$" maxlength="35" placeholder="Adresse E-mail" value="<?php echo $locataire['email']   ?>"  required>
                </div>
